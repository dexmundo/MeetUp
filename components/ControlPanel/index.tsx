    ...
    return (
        <div className='w-full h-full text-center text-white px-4 pb-4 '>
            <div className='w-fit max-w-md h-fit mx-auto gap-6 flex items-center justify-around'>
                ...
                <button className='p-4 bg-rose-600 transition-all ease-in duration-300 shadow-md shadow-rose-900 hover:opacity-75 rounded-3xl'><Image width={32} src={CallEndIcon} alt="call-end-icon" /></button>
